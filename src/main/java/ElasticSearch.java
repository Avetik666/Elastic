...
public class ElasticSearch {
    ...
    public static void main(String[] args) throws IOException {
        ...
        long[] time = new SetTime("May 31 2017 15:00:00.000 ", null).time();
...
//        //by os version
//        SearchResponse response = new ResponseMaker(query, "crashlytics-2017.05", "by_os_version", "os_version", 5)
...
//
//        //by app_version
//        SearchResponse response2 = new ResponseMaker(query, "crashlytics-2017.05", "is_handled", "is_handled", 20)
//                .getResponseWithAggregation(client);
//        System.out.println("By app_version" + "\n" + response2);
//
//
//        //by manufacturer-model
//        SearchResponse response3 = new ResponseMaker(query, "crashlytics-2017.05", "by_manufacturer", "phone_manufacturer", 5, "models_of_manufacturer", "phone_model", 50)
...
//
        //Crash count
        SearchResponse response5 = new ResponseMaker(query1, "crashlytics-2017.05").getResponse(client);

//        System.out.println("Crash count" + "\n" + response5.getHits().getTotalHits());
//
//
        //Crash count by device ID
        SearchResponse response6 = new ResponseMaker(query1, "crashlytics-2017.05", "agg", "device_id", 0)
...
//
       ...
       //by app version with filter
        SearchResponse response9 = new ResponseMaker(query, "crashlytics-2017.05", "by_app_version", "app_version", 20)
